...
<div class="notice success">
    ...
    Tinjau jumlah yang disarankan, kemudian lanjutkan pencatatan pesanan untuk setiap barang.
    <x-pill tone="green" style="float:right">Siap ditindaklanjuti</x-pill>
</div>
...
<section class="card">
    ...
    <div class="card-body">
        <div class="table-wrap">
            <table>
                <thead><tr><th>Prioritas</th><th>Nama Barang</th><th class="numeric">Nilai Prioritas</th><th class="numeric">Saran Restock</th><th>Tindak Lanjut</th><th></th></tr></thead>
                <tbody>
                @foreach($run->results as $result)
                    <tr>
                        ...
                        <td class="numeric"><strong>{{ number_format((float)$result->yi_system, 4, ',', '.') }}</strong></td>
