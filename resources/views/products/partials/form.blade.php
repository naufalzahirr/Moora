...
<details class="advanced-settings" @if($errors->any()) open @endif><summary>Pengaturan saran pembelian <small>Waktu tunggu, cadangan, dan aturan jumlah pesanan</small></summary><div class="form-grid">
