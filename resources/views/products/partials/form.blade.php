...
<details class="advanced-settings" @if($errors->any()) open @endif><summary>Pengaturan operasional lama (opsional) <small>Tidak diperlukan untuk penilaian MOORA</small></summary><div class="form-grid">
