...
<div class="stats-grid action-stats">
    ...
    @else
        <div class="stat-card"><span class="stat-icon {{ $lowStockCount ? 'red' : 'green' }}">{{ $lowStockCount }}</span><div><small>DI BAWAH MINIMUM</small><strong>{{ $lowStockCount }} Barang</strong></div></div>
    @endif
    ...
    <div class="card-body">
        ...
        <div class="table-wrap">
            <table>
                ...
                @empty
                    <tr><td colspan="7" class="empty-cell">Belum ada barang aktif.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
...
<section class="card" style="margin-top:18px">
    ...
    <div class="card-body">
        <form method="GET" class="filter-row" style="margin-bottom:16px">
            ...
            <label class="sr-only" for="movement-from">Dari tanggal</label><input id="movement-from" type="date" name="movement_from" value="{{ $movementFrom }}">
            <label class="sr-only" for="movement-until">Sampai tanggal</label><input id="movement-until" type="date" name="movement_until" value="{{ $movementUntil }}">
...
<dialog id="stock-adjustment" aria-labelledby="stock-adjustment-title">
    ...
    <form method="POST" action="{{ route('inventory.adjust') }}" novalidate>@csrf
